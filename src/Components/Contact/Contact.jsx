  ...
  return (
    <div id='contact' className='contact my-[100px]'>
        <div className='freelance bg-[#E5E5E5] flex flex-col justify-center items-center'>
            ...
            <div className='flex justify-between items-center my-[50px] transition-[.5s]'>
                <div className='flex flex-col mx-5 '>
                    ...
                    <a target='_blank' href="https://www.fiverr.com/s/XLQ2Vqe" className='c-btn py-1 px-3 border text-center  border-black rounded-2xl hover:bg-transparent font-medium text-sm transition-[5s]'>HIRE ME</a>
                </div>
                <div className='flex flex-col mx-5'>
                    <h2 className='text-2xl mb-2 font-medium'>UPWORK</h2>
                    <a href="" className='c-btn py-1 px-3 border text-center  border-black rounded-2xl hover:bg-transparent font-medium text-sm transition-[5s]'>HIRE ME</a>
                </div>
            </div>
        </div>
        ...
        <div className="contact-details flex flex-col justify-center items-center my-10">
            ...
            <div className='min-w-fit bg-white rounded-xl my-3 px-1 py-1 call flex justify-around items-center'>
